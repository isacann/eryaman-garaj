...
| Takip hatırlatması | **TEK basamak: 23 saat** (16 Ağustos, Fatih Bey: "hatırlatma mesajı sadece bir adet olsun... bir gün sonra"). Metin birebir örneğinden, isimli: *"Tekrardan merhabalar Kemal bey, değerlendirmenizi yapabildiniz mi?"* Fiyat hiç gitmediyse nötr varyant. Tarihçe: 20dk/6saat (11 Ağu) → 3saat/20saat (14 Ağu) → tek 23saat (16 Ağu) — **geri dönülmesin** |
