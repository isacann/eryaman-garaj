...
export function sistemPromptUret(secenekler: PromptSecenekleri = {}): string {
  ...
  const teyitBloku =
    fiyat.teyitBekleyenIsler.length > 0
      ? [
          ...
          'Aracı ve kapsamı öğren, iletişim numarasını iste, devir bayrağını kaldır.',
          '',
  ...
  return [
    ...
    '  söylenir.',
    '- RANDEVU/UYGUNLUK SORULDUYSA TELEFON İSTE (Fatih Bey, 12 Ağustos).',
    ...
    '   hasarlı parça onarımı, birden fazla araç): iletişim numarasını iste ve devret.',
    '   Kalıp: "Detaylı bilgi vermek için iletişim numaranızı bırakırsanız en yakın sürede',
    '   müşteri danışmanımız sizinle iletişime geçecektir."',
    ...
    '',
    'Devrederken müşteriyi soğutma: numarasını iste, döneceğimizi söyle, kibarca kapat.',
    '',
    '# Yasaklar',
    '',
